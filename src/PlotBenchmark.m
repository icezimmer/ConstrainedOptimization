function PlotBenchmark(Histories, f_star, iterative_algorithms, dual_comparison, colors, date)
    %{
        Plot the error curve of the algorithms
        Input:
            Histories            : (cell array) history of the algorithms
            f_star               : (float) optimal value of the function in the domain
            iterative_algorithms : (cell array) name of the algorithms
            dual_comparison      : (bool) if true, plot the dual error
            colors               : (cell array) colors for the algorithms
